<template>
  <div class="m-nav">
    <ul class="nav">
      <li class="list">
        <router-link class="db" to="/">我的美团</router-link>
        <dl>
          <dd>
      ...
      <li class="list">
        ...
        <div class="subContainer">
          ...
          <dl class="app">
            ...
            <dd>
              <router-link to="/">
                <img src="https://s0.meituan.net/bs/fe-web-meituan/2d53095/img/appicons/meituan.png" alt="美团App" />
              </router-link>
            </dd>
            <dd>
              <router-link to="nav">
                <img src="https://s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/waimai.png" alt="外卖App" />
              </router-link>
            </dd>
            <dd>
              <router-link to="/">
            ...
            <dd>
              <router-link to="/">
                <img src="https://s1.meituan.net/bs/fe-web-meituan/404d350/img/appicons/dianping.png" alt="点评App" />
              </router-link>
            </dd>
            <dd>
              <router-link to="/">
